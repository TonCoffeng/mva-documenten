exports.handler = async function(event, context) {
  ...
  try {
    ...
    while (true) {
      ...
      // Filter alleen echt verwijderde eruit — gearchiveerde ook tonen
